# Contributing to exposome-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
exposome-schema. These guidelines are not strict rules.
...
The exposome-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the exposome-schema technical leads
...
[issues]: https://github.com/diatomsRcool/exposome-schema/issues/
[pulls]: https://github.com/diatomsRcool/exposome-schema/pulls/
